...
/****** Object:  Database [HMS_db]    Script Date: 9/22/2025 11:09:15 AM ******/
CREATE DATABASE [HMS_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'HMS_db', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\HMS_db.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'HMS_db_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\HMS_db_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [HMS_db] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [HMS_db] SET RECOVERY FULL 
GO
...
ALTER DATABASE [HMS_db] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [HMS_db] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [HMS_db] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [HMS_db] SET QUERY_STORE = OFF
GO
